...
public class MazeTest {
    ...
    @Test
    void inputsValidity() {
        assertNull(JoinabilityAlgorithmMaze.findPath(new ArrayList<>()));
        ...
        assertNull(JoinabilityAlgorithmMaze.findPath(noEntranceMaze));
        ...
        assertNull(JoinabilityAlgorithmMaze.findPath(noExitMaze));
    }

    @Test
    void input00() throws FileNotFoundException {
        ArrayList<ArrayList<Tile>> maze = readInput("00");
        Integer shortestPathDistance = JoinabilityAlgorithmMaze.findPath(maze);
