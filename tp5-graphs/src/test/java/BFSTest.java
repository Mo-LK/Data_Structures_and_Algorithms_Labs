...
//    @Test
//    void input10() throws FileNotFoundException {
//        ArrayList<ArrayList<Tile>> maze = readInput("10");
//        Integer shortestPathDistance = BFSMaze.findPath(maze);
//
//        assertNotNull(shortestPathDistance);
//        assertEquals(9, shortestPathDistance);
//    }
//
//    @Test
//    void input11() throws FileNotFoundException {
//        ArrayList<ArrayList<Tile>> maze = readInput("11");
//        Integer shortestPathDistance = BFSMaze.findPath(maze);
//
//        assertNotNull(shortestPathDistance);
//        assertEquals(9, shortestPathDistance);
